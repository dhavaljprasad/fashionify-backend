...
Requirements:
- Preserve the person's identity exactly: face, skin tone, hairstyle, body shape, and proportions.
- Preserve the person's original pose, camera angle, framing, and background as closely as possible. Do not change the pose unless absolutely necessary to fit the garment naturally.
- Preserve the natural lighting and overall look of the original photo. Do not retouch the skin, smooth the face, enhance makeup, sharpen features, or create a studio-quality or glamour effect.
...
- Fit the garment realistically to the person's shoulders, chest, waist, hips, arms, and legs.
